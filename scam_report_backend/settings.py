"""
Django settings for scam_report_backend project.
...
SECRET_KEY = 'django-insecure-siceg4bt%d38&z*+n42)tz04)tzy$1hd&!tc_(g$u(lm@e3ph='
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',
     'rest_framework', 
    'scam_reports',  # Add your scam_reports app here
...
ROOT_URLCONF = 'scam_report_backend.urls'
...
WSGI_APPLICATION = 'scam_report_backend.wsgi.application'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=365),  # Access token expires in 7 days
